...
#include "plansza/10x8/Plansza10x8.h"
#include "plansza/10x10/Plansza10x10.h"
...
Ruch2:      		cout << "\n" << team_m[who_s]<<" podaj ruch: ";
			...
			if(move[5] != '\0' || move[0] == '\0' || move[1] == '\0' ||
				move[2] == '\0' || move[3] == '\0' || move[4] == '\0' )
			{
Ruch21:				cout << "Zle wprowadzony ruch\n";
				goto Ruch2;
			}
			if(move[0]<'A') x = (move[0]-'0');
			else if(move[0]<'a') x = (move[0]-'A'+1);
			...
			if(plansza1.get_object(x,y).get_type() != type)	goto Ruch21;
